...
export const copy = {
  it: {
    ...
    hero: {
      ...
      title2: "Il miglior ristorante in Valdambra, alle porte del Valdarno.",
      subtitle: "Ristorante gourmet in provincia di Arezzo: cucina toscana contemporanea tra Valdambra e Valdarno.",
    ...
    women: {
      ...
      note: "Una formazione costruita nella ristorazione toscana di alto livello. La Toscana non è soltanto il luogo in cui vivono: è una cultura gastronomica che hanno scelto, studiato, servito e reso propria.",
      role: "Ruolo",
    ...
    kitchen: {
      ...
      captionMain: "Pesce, cotture brevi e precisione.",
  ...
  en: {
    ...
    women: {
      ...
      note: "A training built inside high-level Tuscan hospitality. Tuscany is not only where they live: it is a culinary culture they chose, studied, served and made their own.",
      role: "Role",
    ...
    kitchen: {
      ...
      captionMain: "Fish, short cooking and precision.",
    ...
    menu: {
      ...
      captions: {
        dessert: "Apple cake, baked fresh daily, with vanilla ice cream and warm custard",
        fish: "Fish",
